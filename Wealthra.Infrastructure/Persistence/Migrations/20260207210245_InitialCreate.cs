        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetAmount = table.Column<decimal>(type: "numeric(18,6)", nullable: false),
                    CurrentAmount = table.Column<decimal>(type: "numeric(18,6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    LimitAmount = table.Column<decimal>(type: "numeric(18,6)", nullable: false),
                    CurrentAmount = table.Column<decimal>(type: "numeric(18,6)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expenses_CategoryId_CreatedOn",
                table: "Expenses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Goals_Deadline",
                table: "Goals",
                column: "Deadline");

            migrationBuilder.CreateIndex(
                name: "IX_Incomes_CreatedBy",
                table: "Incomes",
                column: "CreatedBy");
