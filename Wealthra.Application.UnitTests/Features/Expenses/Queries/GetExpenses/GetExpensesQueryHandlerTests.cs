...
namespace Wealthra.Application.UnitTests.Features.Expenses.Queries.GetExpenses;
...
public class GetExpensesQueryHandlerTests
{
    ...
    public GetExpensesQueryHandlerTests()
    {
        ...
        _handler = new GetExpensesQueryHandler(_mockContext.Object, _mockICurrentUserService.Object, _mockCurrencyService.Object, _mockDisplayCurrencyService.Object);
    }
